...
def motivational_quotes():
 ...
 "🚀 Every day is a chance to get better. 🌅"
  "🌈 Embrace challenges; they are opportunities in disguise. 🦸‍♂️"
    ]
...
def random_growth_tips():
  ...
  "❓ Never be afraid to ask for help or clarification."
  "🚀 Push yourself outside your comfort zone."
  "📖 Learn from the stories of others who’ve succeeded."
  "👥 Share knowledge and learn together with a community."
  "⏳ Set aside time each day for personal growth and focus."
  "⚡ Consistency is key; tiny efforts lead to major progress."
  "🌱 Picture your dream outcome and take action every day."
    ]
